...
i3d_fpr_wsal_only_abnormal_path = "graficos/i3d/fpr_camnuvem_sultani.npy"
i3d_tpr_wsal_only_abnormal_path = "graficos/i3d/tpr_camnuvem_sultani.npy"

i3d_ssohc_fpr_wsal_only_abnormal_path = "graficos/ssohc-i3d/fpr_camnuvem_sultani.npy"
i3d_ssohc_tpr_wsal_only_abnormal_path = "graficos/ssohc-i3d/tpr_camnuvem_sultani.npy"
...
data2 = pd.DataFrame({'True Positive Rate' : i3d_ssohc_tpr1, 'False Positive Rate': i3d_ssohc_fpr1})
...
plt.legend(title='Methods', loc='upper left', labels=['I3D', "SSOC+I3D"])

#fig = ax.get_figure()
#fig.savefig("roc_curve_only_abnormal.png") 
plt.savefig("rads_after_before.png")
