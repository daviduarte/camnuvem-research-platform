...
parser.add_argument('--gt', default='list/gt-camnuvem.npy', help='file of ground truth ')
...
parser.add_argument('--lr', type=str, default='[0.00000000000000000001]*15000', help='learning rates for steps(list form)')
